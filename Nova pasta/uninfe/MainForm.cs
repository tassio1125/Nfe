...
namespace uninfe
{
    ...
    public partial class MainForm : Form
    {
            ...
            if (oSge.VerificaRegistro())
            {
                ...
                else if (oSge.RegistroOK() == false)
                {
                    ...
                    if (Ret == DialogResult.Yes)
                    {
                        ...
                        if (oRegistro.ShowDialog() != DialogResult.OK) Application.Exit();
                    }
                    else
                        Application.Exit();
                }
        ...
        {
            if (Empresas.ClearLockFiles(true))
            {
                PararServicos(false);
                ExecutaServicos();
                //ThreadService.Stop();
        ...
        private void tbForceUpdateWSDL_Click_1(object sender, EventArgs e)
        {
            ConfiguracaoApp.ForceUpdateWSDL(true);
        }
    }
    #endregion
}
